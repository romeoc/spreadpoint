(function ($) {
    ...
    SpreadPoint.Templates.Widgets.Type.EnterContest = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-entercontest' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Enter Our Contest{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
    ...
    SpreadPoint.Templates.Widgets.Type.FacebookLike = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-facebooklikepage' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Like Us on Facebook{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
    ...
    SpreadPoint.Templates.Widgets.Type.FacebookShare = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-facebookshare' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Share a Link on Facebook{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
    ...
    SpreadPoint.Templates.Widgets.Type.TwitterTweet = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-twittertweet' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Tweet About Us{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
    ...
    SpreadPoint.Templates.Widgets.Type.TwitterFollow = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-twitterfollow' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Follow Us on Twitter{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
    ...
    SpreadPoint.Templates.Widgets.Type.Reference = [
        "<div class='applied-widget applied-widget-{{referenceId}} widget-type-reference' data-id='{{referenceId}}'>",
            ...
            "<div class='applied-widget-row campaign-form-row'>",
                "<div class='field'>",
                    "<label>* Widget Title<i class='fa fa-question-circle'></i></label><input type='text' class='applied-widget-element' data-key='title' value='{{#if title}}{{title}}{{else}}Tell Your Friends{{/if}}' />",
                "</div>",
                "<div class='note'>",
                    "<p class='comment'></p>",
                "</div>",
